...
(function (root, factory) {
    ...
    var BootstrapDialogModal = function(element, options) {
        if (/4\.\d+\.\d+/.test($.fn.modal.Constructor.VERSION)) { //FIXME for BootstrapV4
    ...
    BootstrapDialog.prototype = {
        ...
        createModal: function () {
            ...
            $modal.prop('dialog', this); // hytcom 2021-08-24
        ...
        createModalDialog: function () {
            ...
            return $('<div class="modal-dialog modal-dialog-scrollable"></div>'); // hytcom 2021-08-24
        },
